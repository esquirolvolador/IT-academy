...
public class Exercici2 {
	...
	//	testFinal(); //si no comentem aquest mètode, ens fallarà, perquè estem intentant canviar el valor de potencia, que no és possible perquè és un atribut final
		...
		public static void testMetodes() {
			...
			audi.frenar(); // el mètode frenar és estàtic i es por cridar des del objecte i des de la classe. (cotxe.frenar();)
			audi.accelerar(); // el mètode accelerar no és estàtic i només es pot cridar des de l'objecte
